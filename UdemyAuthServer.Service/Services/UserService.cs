...
namespace UdemyAuthServer.Service.Services
{
    public class UserService : IUserService
    {
        ...
        public UserService(UserManager<UserApp> userManager, RoleManager<IdentityRole> role)
        {
        ...
        public async Task<Response<NoContent>> CreateUserRoles(string userName)
        {
            ...
            {
                await _role.CreateAsync(new() { Name = "admin" });
                await _role.CreateAsync(new() { Name = "manager" });
            }
